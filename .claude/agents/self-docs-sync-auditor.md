...
- The `skills/_lib/` inventory matches what is actually on disk (`resolve-ws.sh`, `roadmap.sh`, `roadmap-driver.js`, `plan-driver.md`, `setup.md`, `templates/conventional-commits.md`, and nothing it does not list).
