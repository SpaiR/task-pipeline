...
| [`/task:roadmap-to-workflow`](/reference/roadmap-to-workflow) | Autopilot over an approved roadmap: authors and invokes a dynamic Workflow that runs unchecked items in dependency-ordered waves — parallel planning, then serialized implement-and-review per item. |
